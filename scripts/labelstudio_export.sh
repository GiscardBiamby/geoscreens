...
curl "http://localhost:8093/api/projects/5/export?exportType=JSON&download_all_tasks=true" -H "Authorization: Token 3ac2082c83061cf1056d636a25bee65771792731" --output 'geoscreens_003_tasks_export.json'
